...
public class TestActivity extends Activity implements OnClickListener {
	...
	private void Anim() {
		ani_next = AnimationUtils.loadAnimation(this, R.anim.translate_next);
		ani_under = AnimationUtils.loadAnimation(this, R.anim.translate_under);
		ani_pre = AnimationUtils.loadAnimation(this, R.anim.translate_pre);
	}
	...
	private void Copydatabase() {
		db = new quanlycauhoi(TestActivity.this);
		try {
			db.createDataBase();
			db.close();
